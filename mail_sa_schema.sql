CREATE SCHEMA mail_sa;


CREATE TABLE mail_sa.awl (
...
CREATE TABLE mail_sa.bayes_expire (
	id			integer		NOT NULL default '0',
	
	runtime			integer		NOT NULL default '0'
) WITHOUT OIDS;

CREATE INDEX bayes_expire_idx1 ON mail_sa.bayes_expire (id);


CREATE TABLE mail_sa.bayes_global_vars (
...
INSERT INTO mail_sa.bayes_global_vars VALUES ('VERSION','3');


CREATE TABLE mail_sa.bayes_seen (
	id			integer		NOT NULL default '0',
...
CREATE TABLE mail_sa.bayes_token (
	id			integer		NOT NULL default '0',
...
CREATE INDEX bayes_token_idx1 ON mail_sa.bayes_token (token);


CREATE TABLE mail_sa.bayes_vars (
	id			serial		NOT NULL,
...
CREATE UNIQUE INDEX bayes_vars_idx1 ON mail_sa.bayes_vars (username);


CREATE OR REPLACE FUNCTION mail_sa.greatest_int (integer, integer)
 RETURNS INTEGER
 IMMUTABLE STRICT
...
CREATE OR REPLACE FUNCTION mail_sa.least_int (integer, integer)
 RETURNS INTEGER
 IMMUTABLE STRICT
...
CREATE OR REPLACE FUNCTION mail_sa.put_tokens(INTEGER,
                                              BYTEA[],
                                              INTEGER,
                                              INTEGER,
                                              INTEGER)
